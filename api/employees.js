...
employeesRouter.delete('/:employeeId', (req, res, send) => {
...
employeesRouter.get('/:employeeId', (req, res, send) => {
  res.status(200).send({employee: req.employee});
});

employeesRouter.put('/:employeeId', (req, res, send) => {
...
employeesRouter.get('/', (req, res, send) => {
...
employeesRouter.post('/', (req, res, send) => {
  const name = req.body.employee.name,
        position = req.body.employee.position,
        wage = req.body.employee.wage,
        isCurrentEmployee = req.body.employee.isCurrentEmployee === 0 ? 0 : 1;
